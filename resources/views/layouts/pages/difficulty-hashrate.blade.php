    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="center-heading">
                <h2 class="section-title">Difficuly / Hashrate</h2>
            </div>
        </div>
        <div class="offset-lg-3 col-lg-6">
            <div class="center-text">
                <p>The average difficulty and hashrate per day</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function ajax_chart(timeframe, average) {
            $.getJSON(url, {timeframe, average}).done(function (response) {
                difficultyHashrateChart.data = response;
                difficultyHashrateChart.update();
            });
        }
