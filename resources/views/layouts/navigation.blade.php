...
{{--                        <a href="#" class="bg-indigo-700 text-white rounded-md py-2 px-3 text-sm font-medium" aria-current="page">--}}
{{--                            Dashboard--}}
{{--                        </a>--}}

                        <x-nav-item item="test1"></x-nav-item>
                        <x-nav-item item="test2"></x-nav-item>
                        <x-nav-item item="test3"></x-nav-item>
                    </div>
                </div>
            </div>
            <div class="flex lg:hidden">
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen" type="button" class="bg-blue-600 p-2 rounded-md inline-flex items-center justify-center text-indigo-200 hover:text-white hover:bg-indigo-500 hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                    ...
                    -->
                    <svg class="h-6 w-6" :class="{  }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    ...
                    <div x-data="{ open: false }"
                        ...
                        <div>
                            <button @click="open = !open"
                                type="button" class="bg-blue-600 rounded-full flex text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-600 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
